    ...
    <div className="w-full min-h-screen flex justify-center bg-white md:bg-[#1e1e1e]">
      ...
      <div className="w-full max-w-[450px] md:max-w-none min-h-screen bg-white shadow-2xl overflow-x-hidden md:grid md:grid-cols-2">
        ...
        <div className="hidden md:flex flex-col items-center justify-center bg-[#C18A5E] p-16">
          <YouriMascot isXD={false} className="w-60 h-60 drop-shadow-2xl mb-10" />
          <h2 className="text-5xl font-bold text-white tracking-widest drop-shadow-lg">Youri</h2>
          <p className="text-xl text-[#E3CBB8] mt-4 font-medium text-center">Your personalized assistant for easier cooking planning</p>
        </div>
        ...
        <div className="flex flex-col bg-white p-8 pt-16 md:pt-8 md:justify-center">
          ...
          <div className="w-full max-w-md mx-auto">
            ...
            <div className="hidden md:block mb-10">
              <h3 className="text-3xl font-bold text-gray-800 tracking-wide">Selamat Datang di Youri! 👋</h3>
              <p className="text-base text-gray-500 mt-2">Masuk ke akunmu untuk mulai meracik hidangan lezat hari ini.</p>
            </div>
            ...
            <div className="w-full flex justify-center mt-4">
              <button onClick={handleNotAvailable} type="button" className="text-xs text-gray-500 hover:text-gray-800 underline">
            ...
            <div className="w-full flex items-center gap-3 my-7">
              ...
              <span className="text-xs text-gray-400 font-medium whitespace-nowrap">Atau Masuk Dengan</span>
              <div className="flex-1 h-px bg-gray-200"></div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-6">
              ...
              {/* ✅ PERBAIKAN: Tombol Google dengan SVG Logo Asli */}
              <button 
              ...
              <Link to="/register" className="w-full bg-[#E3CBB8] text-gray-800 font-bold py-3 rounded-xl text-center shadow-sm hover:bg-[#d4b9a3] transition-all text-sm flex items-center justify-center">
                Daftar Akun Baru
              </Link>
            </div>
          </div>
