      ...
      <div className="w-full max-w-[450px] md:max-w-none min-h-screen bg-white shadow-2xl overflow-x-hidden md:grid md:grid-cols-2">
        ...
        <div className="hidden md:flex flex-col items-center justify-center bg-[#C18A5E] p-16">
          ...
          <p className="text-xl text-[#E3CBB8] mt-4 font-medium text-center">
            Your new partner in creating delicious and planned home meals
          </p>
        </div>
          ...
          <div className="w-full max-w-md mx-auto">
            ...
            <div className="hidden md:block mb-8">
              <h3 className="text-3xl font-bold text-gray-800 tracking-wide">
                Daftar Akun Koki Baru! 🍳
              </h3>
              <p className="text-base text-gray-500 mt-2">
                Gabung dengan Youri untuk perencanaan masak yang lebih mudah.
              </p>
            </div>
            ...
            >
              ...
              <div className="flex flex-col gap-1 group relative">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 text-lg hover:text-gray-600"
                  >
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-[#C18A5E] text-white font-bold py-3.5 rounded-xl mt-3 shadow-md hover:bg-[#a6754d] transition-all disabled:opacity-70 disabled:cursor-not-allowed tracking-wide"
              >
                {isLoading ? "Sedang Memproses..." : "Daftar Sekarang"}
              </button>
            </form>

            {/* 1. DIVIDER (GARIS PEMISAH) */}
            ...
            {/* 2. TOMBOL GOOGLE SSO (Full Width) */}
            <button
